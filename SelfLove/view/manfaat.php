...
<?php 
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="container-fluid bg-drak mt-4" styel="height: 100vh">
        <div class="card mb-3">
          <img src="../Assets/manfaat.jpeg" class="card-img-top" alt="...">
          <div class="section-subtitle">
            <h2 class="card-title">Manfaat Menerapkan SELF LOVE</h2>
            <p class="card-text"> <p>
                1. Bersyukur atas Segala Hal yang Sudah Dimiliki<br>
            ...
            <p class="card-text"><small class="text-muted">Perlindungan bagi diri, keluarga, dan juga aset berharga tentu penting dalam membantu Anda menghindari berbagai macam risiko yang dapat membuat perencanaan diri akan masa depan Anda menjadi jatuh atau terpuruk.:)</small></p>
          </div>
        </div>
          </div>
        </div>
